...
jQuery(function($) {
   jQuery('body').delegate('#Clausuras_sub_tipo','change',function(){
    jQuery.ajax({
         'url':'index.php?r=clausuras/editar_campos&sub_tipo=' + $('#Clausuras_sub_tipo').val() + '&convencion=' + $('#Clausuras_cod_convencion').val(),
         'cache':false,
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->hiddenField($model,'cod_convencion',array('size'=>20,'maxlength'=>20, )); ?>
