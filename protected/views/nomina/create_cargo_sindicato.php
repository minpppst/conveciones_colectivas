...
<?php /*$dataProvider= new CActiveDataProvider($rawData,array(
    ...
    'pagination'=>array(
        ...
        array(  
                ...
                'id' => 'id',
                'value' => '',
                'checked'=> '$data->getUserLevel($data->id,1,$data->id_empresa)',
                'class' => 'CCheckBoxColumn',
                'selectableRows' => '2',
        ...
        array(
                ...
                'value' => '',//$valor->id,
                'class' => 'CCheckBoxColumn',
                'checked'=> '$data->getUserLevel($data->id,2,$data->id_empresa)',
                'selectableRows' => '2',
        ...
        'class' => 'CCheckBoxColumn',
        'selectableRows' => '1',
        'checked'=> '$data->getUserLevel($data->id,3,$data->id_empresa)',
       ...
       //'name'=>'secretario_ejecutivo','value'=>'CHtml::checkBox("secretario_ejecutivo[]",null,array("value"=>$data->secretario_ejecutivo,"secretario_ejecutivo"=>"secretario_ejecutivo".$data->secretario_ejecutivo))',
        ...
        'class' => 'CCheckBoxColumn',
        'selectableRows' => '1',
       'checked'=> '$data->getUserLevel($data->id,4,$data->id_empresa)',
        ...
        'class' => 'CCheckBoxColumn',
        'selectableRows' => '1',
       'checked'=> '$data->getUserLevel($data->id,5,$data->id_empresa)',
        ...
        'htmlOptions'=>array('width'=>2, 'style'=>'text-align: center;'),
        'class' => 'CCheckBoxColumn',
       'checked'=> '$data->getUserLevel($data->id,6,$data->id_empresa)',
        'value'=>'',
        'selectableRows' => '1',
        ...
        'htmlOptions'=>array('width'=>2, 'style'=>'text-align: center;'),
        'class' => 'CCheckBoxColumn',
        'checked'=> '$data->getUserLevel($data->id,7,$data->id_empresa)',
        'selectableRows' => '1',
        ...
        'id' => 'id7',
        'htmlOptions'=>array('width'=>2, 'style'=>'text-align: center;'),
        'checked'=> '$data->getUserLevel($data->id,8,$data->id_empresa)',
        'class' => 'CCheckBoxColumn',
        'selectableRows' => '1',
        ...
        'id' => 'id8',
        'htmlOptions'=>array('width'=>2, 'style'=>'text-align: center;'),
        'checked'=> '$data->getUserLevel($data->id,9,$data->id_empresa)',
        'class' => 'CCheckBoxColumn',
        'selectableRows' => '1',
        ...
        'htmlOptions'=>array('width'=>2, 'style'=>'text-align: center;'),
        'class' => 'CCheckBoxColumn',
         'checked'=> '$data->getUserLevel($data->id,10,$data->id_empresa)',  
        'selectableRows' => '1',
        ...
        'htmlOptions'=>array('width'=>2, 'style'=>'text-align: center;'),
        'class' => 'CCheckBoxColumn',
        'checked'=> '$data->getUserLevel($data->id,11,$data->id_empresa)',  
        'selectableRows' => '1',
        ...
        'htmlOptions'=>array('width'=>2, 'style'=>'text-align: center;'),
        'class' => 'CCheckBoxColumn',
         'checked'=> '$data->getUserLevel($data->id,12,$data->id_empresa)',  
        'selectableRows' => '1',
        ...
        'class' => 'CCheckBoxColumn',
        'selectableRows' => '1',
         'checked'=> '$data->getUserLevel($data->id,13,$data->id_empresa)',  
        ...
        'headerHtmlOptions'=>array('style'=>'text-align: center; vertical-align: top;'),
        'class' => 'CCheckBoxColumn',
         'checked'=> '$data->getUserLevel($data->id,14,$data->id_empresa)',  
        'selectableRows' => '1',
