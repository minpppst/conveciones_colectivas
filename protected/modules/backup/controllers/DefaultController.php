...
class DefaultController extends Controller
{
	...
	protected function updateMenuItems($model = null)
	{
		...
		switch( $this->action->id)
		{
			...
			default:
				{
					$this->menu[] = array('label'=>Yii::t('app', 'Listar Backups') . ' ' . $model->label(2), 'url'=>array('index'));
					$this->menu[] = array('label'=>Yii::t('app', 'Crear Backup') . ' ' . $model->label(), 'url'=>array('create'));
					...
					$this->menu[] = array('label'=>Yii::t('app', 'Regresar Al Sitio') , 'url'=>Yii::app()->HomeUrl);
				}
				break;
		}
	}
