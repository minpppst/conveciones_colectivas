 ...
 * @property Inspectoria[] $inspectorias
...
class Estados extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'empresas' => array(self::HAS_MANY, 'Empresa', 'estado'),
			'inspectorias' => array(self::HAS_MANY, 'Inspectoria', 'id_estado'),
			'municipioses' => array(self::HAS_MANY, 'Municipios', 'id_estado'),
		);
	}
